...
public class JhipsterSimpleApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterSimpleApplicationApp.class);

    private final Environment env;

    public JhipsterSimpleApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterSimpleApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterSimpleApplicationApp.class);
